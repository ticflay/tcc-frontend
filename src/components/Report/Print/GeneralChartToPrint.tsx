...
export default function GeneralChartToPrint({
  form,
  setSelectedMenu,
}: GeneralChartProps) {
  ...
  return (
    <div className="flex flex-row w-full gap-8 print:flex-col print:items-center">
          ...
          <div className="flex flex-col gap-6 flex-1">
            {generalData.map((data) => {
              return (
                <div
                  key={data.id}
                  className="flex border  bg-white border-solid border-gray-200 rounded-lg p-4 items-center flex-row gap-4"
                >
                  <div className="flex flex-col items-center gap-10 flex-1">
                    <div
                      className="w-96 min-w-[384px]  gap-6 relative flex flex-col justify-between"
                      key={data.id}
                    >
                      ...
                      <div className="relative h-32 overflow-hidden">
                        ...
                        />
                        <span
                          className={`absolute bottom-0 text-4xl font-semibold left-[140px]`}
                        >
                    ...
                    <div className="flex flex-col gap-6 flex-1">
                      <div className="flex flex-col border bg-gray-100 border-solid border-gray-200 rounded-lg p-4 flex-1">
